...
This is my talk on Writing Apps with HotCocoa and MacRuby slides, outlines and all supporting files. I will fork a branch for each re-incarnation of the same talk for different events.

== LICENSE:

Creative Commons Liense - Attribution-NonCommercial-NoDerivs 2.5
